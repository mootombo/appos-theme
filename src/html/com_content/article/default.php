...
<?php $useDefList = ($params->get('show_modify_date') || $params->get('show_publish_date') || $params->get('show_create_date')
	...
	<div class="<?php if(htmlspecialchars($imgfloat) == 'left') { echo 'margin-right'; } else if(htmlspecialchars($imgfloat) == 'margin-right') { echo 'left'; } else { echo 'center large-margin-bottom margin-top'; } ?> pull-<?php echo htmlspecialchars($imgfloat); ?> item-image"> <img
