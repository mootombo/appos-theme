	...
	<div class="sprocket-mosaic-item" data-mosaic-content>
		...
		<div class="sprocket-padding">
			...
			<div class="sprocket-mosaic-image-container">
				<?php if ($item->getPrimaryLink()) : ?><a data-rokbox data-rokbox-size="600 500" href="<?php echo $item->getPrimaryLink()->getUrl(); ?>&tmpl=component"><?php endif; ?>
			...
			<?php if ($item->getPrimaryLink()) : ?>
			<a data-rokbox data-rokbox-size="600 500" href="<?php echo $item->getPrimaryLink()->getUrl(); ?>&tmpl=component" class="sprocket-readmore"><span><?php rc_e('READ_MORE'); ?></span></a>
			<?php endif; ?>
