...
ace.settings = {
	...
	navbar_fixed : function(fix) {
		...
		document.getElementById('appos-settings-navbar').checked = fix;
	},
	...
	breadcrumbs_fixed : function(fix) {
		...
		document.getElementById('appos-settings-breadcrumbs').checked = fix;
	},
	...
	sidebar_fixed : function(fix) {
		...
		document.getElementById('appos-settings-sidebar').checked = fix;
	},
	...
	main_container_fixed : function(inside) {
		...
		document.getElementById('appos-settings-add-container').checked = inside;
